...
- **Concepts**: Core ideas (agents, workflows, tools)
...
The main llms.txt file provides an agent-friendly overview of all documentation:
...
## Agent-Friendly Documentation with llms.txt

**Critical feature**: Add `/llms.txt` to any documentation URL to get clean, agent-friendly markdown.
...
```
https://mastra.ai/reference/workflows/workflow-methods/then/llms.txt
```

The `/llms.txt` version:
...
Add `/llms.txt` to the end of any documentation URL:
```
https://mastra.ai/reference/workflows/workflow-methods/then/llms.txt
```
...
```
WebFetch({
  url: "https://mastra.ai/reference/workflows/workflow-methods/then/llms.txt",
...
1. **Always use /llms.txt** for fetching documentation
